...
mnist_trainingweight_l2_expnames = ['fashion_MNIST_DAC_l2_tau_10_seed_1',
...
mnist_trainingweight_origin_expnames = ['fashion_MNIST_DAC_cosine_origin_tau_100_seed_1',
                                        'fashion_MNIST_DAC_cosine_origin_tau_200_seed_1',
                                        'fashion_MNIST_DAC_cosine_origin_tau_300_seed_1',]

mnist_priorweight_invloss_expnames = ['fashion_MNIST_DAC_priorweight_invloss_tau_5_seed_1',
                                      'fashion_MNIST_DAC_priorweight_invloss_tau_10_seed_1',
                                      'fashion_MNIST_DAC_priorweight_invloss_tau_30_seed_1',]

mnist_priorweight_l2_expnames = ['fashion_MNIST_DAC_priorweight_l2_tau_10_seed_1',
