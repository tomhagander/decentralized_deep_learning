from utils.testing_utils import test_on_fashion_MNIST
import argparse
import pickle
...
if __name__ == '__main__':
    ...
    if verbose:
        print('Testing fashion_MNIST on clients from experiment: {}'.format(args.experiment))
    ...
    acc_matrix = test_on_fashion_MNIST(clients, quick=quick, verbose=verbose)
        
    if verbose:
        print('Testing complete')
    
    with open('save/'+args.experiment+'/fashion_MNIST_acc_matrix.pkl', 'wb') as f:
