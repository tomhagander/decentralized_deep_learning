...
for tau in [5,10,30, 50 ,100]:
    double_trainingweight_l2_expnames.append('DOUBLE_l2_seed_{}_tau_{}'.format(seed,tau))
...
for tau in [50, 100, 300, 500,2000,5000]:
