...
#taus_trainingweight_invloss = np.logspace(np.log10(50000), np.log10(5000000), num=8)
taus_trainingweight_invloss = np.logspace(np.log10(10), np.log10(10000), num=8)
...
#taus_priorweight_invloss = np.logspace(np.log10(50000), np.log10(5000000), num=8)
taus_priorweight_invloss = np.logspace(np.log10(10), np.log10(10000), num=8)
...
for lr in lrs:
    ...
    for tau in taus_trainingweight_l2:
        commands.append('python3 run_experiment.py --gpu 0 --dataset toy_problem --nbr_rounds 40 --nbr_clients 99 --n_data_train 50 --n_data_val 100 --seed {} --batch_size 8 --nbr_local_epochs 1 --lr {} --stopping_rounds 50 --nbr_neighbors_sampled 5 --prior_update_rule softmax --similarity_metric l2 --tau {} --client_information_exchange DAC --experiment_name TOY_DAC_l2_lr_{}_tau_{}_seed_{} --delusion 0.0'.format(seed, lr, tau, lr, tau, seed))

    # cosine
    for tau in taus_trainingweight_cosine:
        commands.append('python3 run_experiment.py --gpu 0 --dataset toy_problem --nbr_rounds 40 --nbr_clients 99 --n_data_train 50 --n_data_val 100 --seed {} --batch_size 8 --nbr_local_epochs 1 --lr {} --stopping_rounds 50 --nbr_neighbors_sampled 5 --prior_update_rule softmax --similarity_metric cosine_similarity --cosine_alpha 0.0 --tau {} --client_information_exchange DAC --experiment_name TOY_DAC_cosine_lr_{}_tau_{}_seed_{} --delusion 0.0'.format(seed, lr, tau, lr, tau, seed))
...
toy_priorweight_invloss_tauopt = 10000 # not determined
