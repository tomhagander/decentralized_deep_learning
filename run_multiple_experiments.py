...
'''
# cosine - running on edvinbox core8_tb
for tau in taus:
...
# cosine origin - running on edvinbox core7_tb
for tau in taus:
...
# invloss priorweight - running on edvinbox core5_tb
for tau in taus:
...
# l2 priorweight - running on edvinbox core6_tb
for tau in taus:
...
toy_trainingweight_l2_tauopt = 0 # not determined
toy_trainingweight_cosine_tauopt = 0 # not determined
toy_trainingweight_cosine_origin_tauopt = 0 # not determined
toy_priorweight_invloss_tauopt = 0 # not determined
toy_priorweight_l2_tauopt = 0 # not determined
toy_priorweight_cosine_tauopt = 0 # not determined
toy_priorweight_cosine_origin_tauopt = 0 # not determined
